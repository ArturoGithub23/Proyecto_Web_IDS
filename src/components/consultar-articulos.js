...
export class ConsultarArticulos extends LitElement {
  ...
  _consultarArticulos() {
    ...
    return html`${this.articulos === null ||
    this.articulos.length === 0 ||
    this.articulos === undefined
      ? html`<span class="null">No hay articulos</span>`
      : html`
                ...
                ${this.articulos.map((articulo) => {
                  return html`
                    ...
                    <tr
                      ...
                      id="${articulo.titulo.replace(" ", "_") +
                      "_" +
                      articulo.id}"
                    >
                      <td colspan="5">
                        ${this._renderizarContenido(articulo)}
                      </td>
                    </tr>
                  `;
                })}
  ...
  _eliminarArticulo(e) {
    ...
    if (
      Object.keys(JSON.parse(window.localStorage.getItem("articulos")))
        .length === 0
    ) {
